...
public class GuiUtils {
    ...
    public GuiUtils(AardvarkGui parent) {
        this.parent = parent;
        semanticAnnotation = new SemanticAnnotation(parent);
...
//                }
    ...
    public org.jdom.Document createDocument() {
        ...
        Mpeg7ImageDescription m7id = new Mpeg7ImageDescription(AnnotationToolkit.getMpeg7MediaInstance(parent.currentFile),

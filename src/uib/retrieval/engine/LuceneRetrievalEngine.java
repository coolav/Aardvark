...
//                    System.out.println("NumberOfRelations: " + l.size());
                    ...
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Name/Name", "Name", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Creator/Name", "Creator", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Period/Name", "Period", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Technique/Name", "Technique", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Materials/Name", "Materials", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Height/Name", "Height", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Date/Name", "Date", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Actor/Name", "Actor", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Width/Name", "Width", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Location/Name", "Location", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Activity/Name", "Activity", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Theme/Name", "Theme", all);
                    addToDocument(idxDocument, e, "//Image/TextAnnotation/StructuredAnnotation/Concept/Name", "Concept", all);
                    ...
                    //    status.append('%');
                    //    parent.setStatus(status.toString());
                    //}
